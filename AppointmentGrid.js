function appointmentFunction() {
	...
	var grid;
	var columnFilters = {};
	var data = document.getElementById("appointmentDiv").value;
  ...
  var appointmentId=[];
	...
	appointmentId.push(data1[i]['appointregid']);
     console.log(data1[i]['appointregid']);
 ...
 function dateFormatter(row, cell, value, columnDef, dataContext) {
  ...
  return formattedDate; // Return the formatted date string
	...
	/* set unique it to array */
		...
		let a=dataContext.appointregid;
	...
	{
		id: "appoinmentrequireddate",
		name: "Appoinmentrequired Date",
		field: "appoinmentrequireddate",
		sortable: true,
...
var options = {
	...
	$(function() {
		...
		grid = new Slick.Grid("#appointmentGrid", dataView, columns, options);
